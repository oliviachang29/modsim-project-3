function [T,M,did_hit_piano,end_time] = ode_penny(initial_speed, theta_in_degrees)
    ...
    distance_to_piano_lower_bound = x_distance_to_piano - distance_to_piano_margin_error;
    distance_to_piano_upper_bound = x_distance_to_piano + distance_to_piano_margin_error;
    
    % convert degrees to radians
    theta = theta_in_degrees * (pi/180);
    
    % set initial position
    P = [0; initial_height_launcher];
